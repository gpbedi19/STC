...
public partial class Print_Individual_Certificate : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            command.CommandText = "SELECT NAME, INSTITUTE, COURSE_NAME, DEPTT, START_DATE,END_DATE, CERTIFICATE_NO, VENUE, DURATION from PARTICIPANT WHERE ATTENDANCE = '1' AND ID = '" + ID + "' ORDER BY NAME";

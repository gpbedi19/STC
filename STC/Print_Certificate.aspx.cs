...
public partial class Print_Certificate : System.Web.UI.Page
{
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            command.CommandText = "SELECT ID FROM PARTICIPANT WHERE OPLAN_NO = '" + OPLAN_NO + "'AND ATTENDANCE='1' ORDER BY NAME";
            SqlDataReader sdr = command.ExecuteReader();
            while (sdr.Read())
            ...
            connection.Close();
            Response.Redirect("Print_Certificates.aspx?oplanno=" + OPLAN_NO);
        }
        catch (Exception ex)
        {
            Console.WriteLine(ex.Message);
    ...
    protected void Button4_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            connection.Close();
            Response.Redirect("Print_All_Certificates.aspx?oplanno=" + OPLAN_NO);
        }
        catch (Exception ex)
        {
            Console.WriteLine(ex.Message);

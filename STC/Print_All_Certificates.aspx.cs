    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try{
           ...
           // command.CommandText = "SELECT NAME, INSTITUTE, COURSE_NAME, DEPTT, START_DATE,END_DATE, CERTIFICATE_NO from PARTICIPANT WHERE ATTENDANCE='Y' AND OPLAN_NO = '"+OPLANNO+"' ORDER BY NAME";
            command.CommandText = "SELECT NAME, INSTITUTE, COURSE_NAME, DEPTT, START_DATE,END_DATE, CERTIFICATE_NO, VENUE, DURATION from PARTICIPANT WHERE OPLAN_NO = '" + OPLANNO + "' AND ATTENDANCE = '1' ORDER BY NAME;";

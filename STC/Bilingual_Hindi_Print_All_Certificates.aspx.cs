...
public partial class Hindi_Print_All_Certificates : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            command.CommandText = "SELECT HINDI_NAME, HINDI_INSTITUTE, HINDI_COURSE_NAME, HINDI_DEPTT, START_DATE,END_DATE, CERTIFICATE_NO, HINDI_VENUE, HINDI_DURATION from PARTICIPANT WHERE OPLAN_NO = '" + OPLANNO + "' AND ATTENDANCE = '1' ORDER BY NAME";
            ...
            while (sdr.Read())
            {
                ...
                html.Append("<p style='page-break-after:always'><p align='right'>" + "प्रमाण पत्र संख्या: " + certino +"</p><br>");
                html.Append("<br>");
                html.Append("<br>");
                html.Append("<br>");

<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master" CodeFile="~/TotalCoursesPlanned.aspx.cs" Inherits="AttendedParticipate" %>
...
<body>
    ...
    <table class="style1">
        <tr>
            <td class="style10" colspan="4">
                <center><b><u>NO. OF COURSES PLANNED AND CONDUCTED DEPTT. WISE & DATE WISE BY NITTTR</u></b></center></td>
        </tr>
        <tr>
            <td class="style13">
                &nbsp;</td>
        ...
        <tr>
            <td class="style13">
                &nbsp;</td>
            <td class="style4">
               <b> <asp:Label ID="Label1" runat="server" Text="Co-ordinating Deptt."></asp:Label></b>
            </td>
            <td class="style11">
 ...
 Width="170px"></asp:TextBox>
                    ...
                    </span>To:</strong><asp:TextBox ID="enddate" placeholder="DD/MM/YYYY" runat="server" 
        ...
        <tr>
            ...
            &nbsp;&nbsp;
                ...
                <asp:Button ID="Button3" runat="server" onclick="Button3_Click" Text="Search" 
                    BackColor="#3333CC" BorderColor="White" ForeColor="White" 
                    ValidationGroup="a" />
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <table class="style1">
        <tr>
            <td align="center">
              <h3>  <u><asp:Label ID="Label2" runat="server" 
                      Text="No. Of Courses Planned  &amp; Conducted Deptt Wise & Date Wise" 
